...
*/
#pragma once
#ifndef GCG_CAMERA_STATUS
#define GCG_CAMERA_STATUS
#include <cinttypes>
...
constexpr int32_t BATTERY_PRESENT_ID = 1;
constexpr CAMERA_STATUS_TYPE BATTERY_PRESENT_TYPE = CAMERA_STATUS_TYPE::BOOLEAN;
constexpr char* BATTERY_PRESENT_NAME = "Battery Present";
constexpr int32_t BATTERY_PRESENT_AVA = MODEL_MISSION_ALL;
